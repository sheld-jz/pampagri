...
(function () {
  ...
  function goTo(index) {
    ...
    // Animate bars in the newly visible slide
    const slide = wrapper.querySelectorAll('.stat-slide')[current];
    slide.querySelectorAll('.bar-fill-slide').forEach(bar => {
      bar.style.width = '0%';
      // Slight delay triggers CSS transition
